...
const CodeArtPreview = ({ title, image, type, description }) => {
  //if (type % 2 == 0) {
    return (
      ...
      >
        <div className="flex-wrap justify-end w-3/4 max-w-lg ml-4 mr-8 text-right md:flex md:w-1/2 xl:w-1/3">
          <Header variant="4">{title}</Header>
          <div className="flex w-full mt-4 mb-4 boxshadow-3d-right">
            <div className="w-full m-4 text-sm text-white prose md:text-md lg:text-lg"
  ...
  //        />
  //      </div>
  //      <div className="flex-wrap justify-start w-3/4 max-w-lg ml-8 mr-4 text-left md:flex md:w-1/2 xl:w-1/3">
